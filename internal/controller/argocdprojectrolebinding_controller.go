...
// +kubebuilder:rbac:groups=rbac-operator,resources=argocdprojectrolebindings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rbac-operator,resources=argocdprojectrolebindings/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=rbac-operator,resources=argocdprojectrolebindings/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the ArgoCDProjectRoleBinding object against the actual cluster state, and then
